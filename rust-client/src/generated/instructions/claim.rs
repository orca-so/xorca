...
///   2. `[writable]` pending_claim_account
///   3. `[writable]` staker_lst_account
///   4. `[]` lst_mint_account
///   5. `[]` staking_pool_stake_token_account
...
impl ClaimBuilder {
    ...
    #[inline(always)]
    pub fn staker_lst_account(
        &mut self,
        staker_lst_account: solana_program::pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = Claim {
            ...
            staker_lst_account: self
                .staker_lst_account
                .expect("staker_lst_account is not set"),
...
impl<'a, 'b> ClaimCpiBuilder<'a, 'b> {
    ...
    pub fn staker_lst_account(
        &mut self,
        staker_lst_account: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
