...
impl CancelStake {
  pub fn instruction(&self, args: CancelStakeInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CancelStakeInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
impl CancelStakeBuilder {
  pub fn new() -> Self {
    ...
    pub fn staking_pool_stake_token_account(&mut self, staking_pool_stake_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn pending_claim_account(&mut self, pending_claim_account: solana_program::pubkey::Pubkey) -> &mut Self {
                        self.pending_claim_account = Some(pending_claim_account);
                    self
    }
            #[inline(always)]
    pub fn staker_stake_token_account(&mut self, staker_stake_token_account: solana_program::pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = CancelStake {
                              staker_account: self.staker_account.expect("staker_account is not set"),
                                        ...
                                        pending_claim_account: self.pending_claim_account.expect("pending_claim_account is not set"),
                                        staker_stake_token_account: self.staker_stake_token_account.expect("staker_stake_token_account is not set"),
...
impl<'a, 'b> CancelStakeCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    Self { instruction }
      ...
      #[inline(always)]
    pub fn staker_account(&mut self, staker_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
    ...
    pub fn staking_pool_stake_token_account(&mut self, staking_pool_stake_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn pending_claim_account(&mut self, pending_claim_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.pending_claim_account = Some(pending_claim_account);
                    self
    }
      #[inline(always)]
    pub fn staker_stake_token_account(&mut self, staker_stake_token_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = CancelStakeInstructionArgs {
                                                              claim_index: self.instruction.claim_index.clone().expect("claim_index is not set"),
                                    };
        let instruction = CancelStakeCpi {
        __program: self.instruction.__program,
                  
          staker_account: self.instruction.staker_account.expect("staker_account is not set"),
          ...
          pending_claim_account: self.instruction.pending_claim_account.expect("pending_claim_account is not set"),
                  
          staker_stake_token_account: self.instruction.staker_stake_token_account.expect("staker_stake_token_account is not set"),
