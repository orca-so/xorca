  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = Initialize {
          ...
          let args = InitializeInstructionArgs {
                                                              wind_up_period_s: self.wind_up_period_s.clone().expect("wind_up_period_s is not set"),
                                                                  cool_down_period_s: self.cool_down_period_s.clone().expect("cool_down_period_s is not set"),
                                                                  lst_mint_decimals: self.lst_mint_decimals.clone().expect("lst_mint_decimals is not set"),
                                    };
...
impl<'a, 'b> InitializeCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    Self { instruction }
      ...
      #[inline(always)]
    pub fn payer_account(&mut self, payer_account: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = InitializeInstructionArgs {
                                                              wind_up_period_s: self.instruction.wind_up_period_s.clone().expect("wind_up_period_s is not set"),
                                                                  cool_down_period_s: self.instruction.cool_down_period_s.clone().expect("cool_down_period_s is not set"),
                                                                  lst_mint_decimals: self.instruction.lst_mint_decimals.clone().expect("lst_mint_decimals is not set"),
                                    };
        let instruction = InitializeCpi {
        __program: self.instruction.__program,
                  
          payer_account: self.instruction.payer_account.expect("payer_account is not set"),
